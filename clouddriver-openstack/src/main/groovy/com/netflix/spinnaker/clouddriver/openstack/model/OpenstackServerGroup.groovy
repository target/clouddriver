...
class OpenstackServerGroup implements ServerGroup, Serializable {
  ...
  @Override
  Long getCreatedTime() {
    asg ? asg.createdTime as Long : null
  }
  ...
  InstanceCounts getInstanceCounts() {
    instances ?
      new InstanceCounts(total: instances.size(),
  ...
  Capacity getCapacity() {
    asg ?
      new Capacity(min: asg.minSize ? asg.minSize as Integer : 0, max: asg.maxSize ? asg.maxSize as Integer : 0)
      : null
  }
