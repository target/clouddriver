...
class BlockingStatusChecker {
  ...
  static BlockingStatusChecker from (StatusChecker s) {
    new BlockingStatusChecker(s, TimeUnit.MINUTES.toMillis(10), TimeUnit.SECONDS.toMillis(10))
  }

  static BlockingStatusChecker from (long timeout, long pollInterval, StatusChecker s) {
    new BlockingStatusChecker(s, timeout, pollInterval)
  }
