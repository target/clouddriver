...
class DeregisterOpenstackInstancesAtomicOperation extends AbstractRegistrationOpenstackInstancesAtomicOperation {
  ...
  /*
   * curl -X POST -H "Content-Type: application/json" -d '[ { "deregisterInstancesFromLoadBalancer": { "loadBalancerIds": ["2112e340-4714-492c-b9db-e45e1b1102c5"], "instanceIds": ["155e68a7-a7dd-433a-b2c1-c8d6d38fb89a"], "account": "test" }} ]' localhost:7002/openstack/ops
